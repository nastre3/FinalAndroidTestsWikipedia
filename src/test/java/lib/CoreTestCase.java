...
public class CoreTestCase {
    ...
    public void setUp() throws Exception {
        ...
        if (PlatformSelector.PLATFORM.equals("android")) {
            this.driver = new AndroidDriver<>(URL, this.getAndroidDesiredCapabilities()); // Capabilities - св-ва девайса/приложения для запускаемой сессии - воз-ся в конструктор
        } else {
